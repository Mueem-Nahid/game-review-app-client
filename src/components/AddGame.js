               ...
               <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                     ...
                     <div className="mt-2">
                        <div
                           ...
                           <input
                              ...
                              className="block p-3 flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                           />
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="col-span-full">
                     ...
                     <div className="rounded-lg bg-gray-50 ">
                        <div>
                           <span
                              className="flex justify-center items-center text-[12px] mb-1 text-red-500">{error}</span>
                           ...
                           <div className="flex flex-wrap justify-center gap-2 mt-2">
                              {images.map((file, key) => {
                                 return (<div key={key} className="overflow-hidden relative">
                                    <i onClick={() => {
